...
export default function AnalyticsView({ products }: AnalyticsViewProps) {
  ...
  // Hourly sales data (in terms of order quantities)
  const hourlySales = [
    { hour: '08:00', qty: 12 },
    { hour: '10:00', qty: 26 },
    { hour: '12:00', qty: 42 },
          ...
          <div>
            <div className="flex items-center justify-between mb-6 border-b border-[#1a1a1a] pb-4">
              <div>
                <h3 className="text-xs font-black text-white uppercase tracking-[0.25em] flex items-center gap-2">
                  <Activity className="w-4 h-4 text-[#FF4D00]" /> ແນວໂນ້ມອໍເດີການຂາຍມື້ນີ້ (Qty)
                </h3>
              ...
              <span className="text-[10px] font-black bg-[#161616] border border-[#FF4D00]/20 text-[#FF4D00] px-3 py-1.5 uppercase tracking-widest rounded-none flex items-center gap-1">
                130 ອໍເດີ <ArrowUpRight className="w-3.5 h-3.5" />
              </span>
            </div>
            ...
            <div className="w-full h-64 relative mt-4">
              <svg className="w-full h-full overflow-visible" viewBox="0 0 600 240">
                ...
                {/* Left Y-axis labels */}
                <text x="32" y="34" className="text-[9px] fill-neutral-400 font-mono font-black tracking-wider text-right" textAnchor="end">50 Qty</text>
                <text x="32" y="94" className="text-[9px] fill-neutral-400 font-mono font-black tracking-wider text-right" textAnchor="end">30 Qty</text>
                <text x="32" y="154" className="text-[9px] fill-neutral-400 font-mono font-black tracking-wider text-right" textAnchor="end">15 Qty</text>
                <text x="32" y="214" className="text-[9px] fill-neutral-400 font-mono font-black tracking-wider text-right" textAnchor="end">0 Qty</text>
              ...
              {hoveredHour !== null && (
                ...
                >
                  ...
                  <p className="whitespace-nowrap">ຈຳນວນອໍເດີ: <span className="font-black text-[#FF4D00]">{hourlySales[hoveredHour].qty} ອໍເດີ</span></p>
                </div>
              )}
            </div>
          </div>
