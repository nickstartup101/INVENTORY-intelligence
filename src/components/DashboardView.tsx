    ...
    <div className="p-6 md:p-10 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-card p-6 rounded-none flex flex-col gap-2 relative overflow-hidden group border-r-4 border-[#FF4D00]">
          <span className="text-[10px] font-black text-[#FF4D00] uppercase tracking-[0.25em]">ຍອດຂາຍມື້ນີ້</span>
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black text-white tracking-tighter">{totalSalesFormatted}</span>
            <span className="text-xs text-[#FF4D00] font-black tracking-widest uppercase">LAK</span>
          </div>
